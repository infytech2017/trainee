...
public class InfyEmployment {
    public static void main(String[] args) {
        ...
        Address addressSesh = new Address();
         /*<bean id="addressSesh" class="com.infy.di.Address">
        </bean>*/
    ...
    /*    <bean id="addressRavi" class="com.infy.di.Address">
        ...
        /*    <bean id="addressAarohi" class="com.infy.di.Address">
                <property name="currentAddress" value="Edenburg, Scotland"></property>
                <property name="permenentAddress" value="Pandhurna, MP"></property>
        </bean>*/


        /*    <bean id="empAarohi" class="com.infy.di.Employee2">
